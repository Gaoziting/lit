...
function canEdit(){
    ...
    if (is_bool($rst)) {
        ...
        $pla = $row['place'];
        $fromUId = $row['user_id'];
        // $sql_count = "SELECT acti_view.count(*) AS vieN,acti_focus.count(*) AS focN,comment.count(*) AS comN FROM acti_view,acti_focus,comment WHERE activity_id='$aid'";
        $sql_count = "SELECT count(*) FROM acti_view WHERE activity_id='$aid'
        UNION ALL
        SELECT count(*) FROM acti_focus WHERE activity_id='$aid'
        UNION ALL
        SELECT count(*) FROM comment WHERE activity_id='$aid'";
        ...
        <div class="body">
            ...
            <div class="content2">
                <div class="cont-head">
                    ...
                    <div>主办方<span class="organizer">好</span>
                        <span class="date"><?php echo $dat?><i class="icon-clock"></i></span></div>
                    <span class="place">好<i class="icon-location3"></i></span>
                    <div class="count">
                        <span><i class="icon-eye"></i><?php echo $vieN?></span>
                        <span><i class="icon-bookmarks"></i><?php echo $focN?></span>
                        <span><i class="icon-bubbles"></i><?php echo $comN?></span>
                    </div>
                </div>
                <hr>
